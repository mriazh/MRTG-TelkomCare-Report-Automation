...
from mrtg_automation.shared.paths import DATA_DIR, CONFIG_DIR, REPORTS_DIR, LOGS_DIR
...
print(
    f"C DONE: DATES={summary['dates_processed']}, TARGETS={summary['targets']}, EXPECTED={summary['expected']}, OK={summary['ocr_ok']}, FAIL={summary['ocr_fail']}, IMAGES_INSERTED={summary['image_inserted']}, MISSING_SCREENSHOTS={summary['missing_screenshots']}, MISSING_MAPPINGS={summary['missing_mappings']} in {duration:.2f}s"
)
