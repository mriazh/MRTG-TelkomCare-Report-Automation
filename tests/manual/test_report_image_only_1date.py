...
def main():
    ...
    if (
        ...
        and summary.get("dates_processed") == 1
        and summary.get("targets") == 20
        and summary.get("expected") == 20
        and summary.get("image_inserted") == 20
        and summary.get("missing_screenshots") == 0
        and summary.get("missing_mappings") == 0
        and summary.get("failed_inserts") == 0
    ):
