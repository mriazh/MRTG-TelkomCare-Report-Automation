...
DATA_DIR = Path(os.getenv("MRTG_DATA_DIR", OUTPUT_DIR / "data" / "MRTG-Data")).expanduser().resolve()
REPORTS_DIR = OUTPUT_DIR / "reports"
LOGS_DIR = OUTPUT_DIR / "logs"
STATE_DIR = OUTPUT_DIR / "state"
SCREENSHOTS_DEBUG_DIR = OUTPUT_DIR / "screenshots"

OCR_TEMPLATE_FILE = CONFIG_DIR / "MRTG-Monthly-Report-on-Internet-Bandwidth-Utilization-by-Telkom.xlsx"
IMAGE_ONLY_TEMPLATE_FILE = CONFIG_DIR / "MRTG-Monthly-Report-on-Internet-Bandwidth-Utilization-by-Telkom (Img only).xlsx"
...
def get_config_files(config_root: Path | str | None = None) -> ConfigPathsDict:
    ...
    return ConfigPathsDict({
        ...
        "template_ocr": root / "MRTG-Monthly-Report-on-Internet-Bandwidth-Utilization-by-Telkom.xlsx",
        "template_img_only": root / "MRTG-Monthly-Report-on-Internet-Bandwidth-Utilization-by-Telkom (Img only).xlsx",
    })


def ensure_directories(output_dir: Path | str | None = None, config_dir: Path | str | None = None, output_root: Path | str | None = None):
